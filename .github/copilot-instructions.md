# Copilot Instructions for LifeSort
LifeSort is an AI-powered local file organizer built with Rust and Tauri. It runs fully offline, using local AI models via Ollama to recognize, classify, tag, and sort files, photos, PDFs, and documents into a clean folder structure, with no cloud, no tracking, and no manual sorting.
## Code style
